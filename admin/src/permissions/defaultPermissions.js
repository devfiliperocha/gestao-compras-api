const permissions = {
  marketplace: CUSTOM_VARIABLES.NODE_ENV === 'development' ? {
    main: [
    ...
    main: [
      { action: 'admin::marketplaceall', subject: null },
    ],
    install: [{ action: 'admin::marketplace.all', subject: null }],
    read: [
      { action: 'admin::marketplace.all', subject: null },
    ],
    uninstall: [{ action: 'admin::marketplace.all', subject: null }],
  },
  settings: {
    roles: {
      main: [
